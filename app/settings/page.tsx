...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h2 className="text-xl font-semibold text-zinc-800 mb-6">系统设置</h2>

      {currentRole !== '超级管理员' && (
        <div className="mb-6 px-4 py-3 bg-amber-50 text-amber-700 text-sm rounded border border-amber-200">
      ...
      <div className="bg-white border border-zinc-200 rounded-lg p-5 mb-6">
        <h3 className="text-md font-semibold text-zinc-700 mb-4">配套价格配置</h3>
      ...
      <div className="bg-white border border-zinc-200 rounded-lg p-5">
        <h3 className="text-md font-semibold text-zinc-700 mb-4">积分规则配置</h3>
        <div className="space-y-3 text-sm">
          <div className="flex justify-between p-3 bg-zinc-50 rounded">
