...
export default function RedemptionPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <h2 className="text-lg md:text-xl font-semibold text-zinc-800 mb-4 md:mb-6">兑换商城</h2>

      {/* 礼品列表 — 1 col mobile, 2 col tablet, 4 col desktop */}
      <div className="bg-white border border-zinc-200 rounded-lg p-4 md:p-5 mb-4 md:mb-6">
        <h3 className="text-md font-semibold text-zinc-700 mb-3 md:mb-4">可兑换礼品</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
          {gifts.map((gift) => (
            ...
            >
              <div className="text-base md:text-lg font-semibold text-zinc-800 mb-1">{gift.name}</div>
      ...
      {canAudit && (
        <div className="bg-white border border-zinc-200 rounded-lg p-4 md:p-5 mb-4 md:mb-6">
          <h3 className="text-md font-semibold text-zinc-700 mb-3 md:mb-4">
            待审核兑换
                        ...
                        <td className="px-3 py-2 text-center">
                          <div className="flex justify-center gap-2">
                            ...
                            <button
                              ...
                              className="px-3 py-1.5 text-xs bg-red-600 text-white rounded hover:bg-red-700 min-h-[36px]"
                            >
                              驳回
                            </button>
                          </div>
