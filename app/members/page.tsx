  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-semibold text-zinc-800">会员管理</h2>
        {!isIntern && (
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-zinc-50 border-b border-zinc-200">
              <th className="text-left px-4 py-3 font-medium text-zinc-600">会员编号</th>
              <th className="text-left px-4 py-3 font-medium text-zinc-600">姓名</th>
              <th className="text-left px-4 py-3 font-medium text-zinc-600">手机</th>
              <th className="text-right px-4 py-3 font-medium text-zinc-600">总积分</th>
              <th className="text-right px-4 py-3 font-medium text-zinc-600">可用积分</th>
              <th className="text-right px-4 py-3 font-medium text-zinc-600">已到期</th>
              <th className="text-center px-4 py-3 font-medium text-zinc-600">状态</th>
              <th className="text-center px-4 py-3 font-medium text-zinc-600">操作</th>
            </tr>
          </thead>
          <tbody>
            {members.map((m) => (
